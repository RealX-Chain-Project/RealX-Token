...
/**
 * @title RealX Token
 * @author RealX- chain project
 * @notice Implements a realX tokenization contract with revenue distribution.
 */
contract RealX Token is ERC20, Ownable {
    ...
    /**
     * @notice The constructor for the RealX Token. This contract relates
     * to a unique realX chain portfolio and each token minted is a share.
     ...
     * @param _recipient The address to receive the RealX Tokens.
     * @param _amount The amount of RealX Tokens to send.
     */
